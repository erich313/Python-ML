...
def SARSA(env, num_episodes, alpha=0.1, gamma=0.9, epsilon=1, epsilon_decay_rate=0.001):
    # SARSA algorithm
    '''
    Args:
...
if __name__ == "__main__":
    env = gym.make('FrozenLake-v1', map_name="8x8", is_slippery=False, render_mode=None, max_episode_steps=1000)
    cenv = CustomEnvWrapper(env)
    Q = SARSA(cenv, num_episodes=15000)



# break the limit of 200 truncated
# start agent randomly
# prohibit unvalid way
