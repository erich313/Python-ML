...
class Agent:
    def __init__(self):
        ...
        self.lr_critic = 1e-3  # learning rate for critic
    ...
    def train(self, render, episodes, slippery, max_episode_steps):
        ...
        for episode in tqdm(range(episodes), desc="Training Episodes", ncols=150):
            ...
            for t in itertools.count():
                ...
                transition.append(True if terminated or truncated else False)

                # Update the networks (Actor-Critic Algorithm)
                actorcritic.update(transition, num_states)
